...
-- SUB
    SUBER: sub16 port map ('0', status(0), input1, input2, W1);
...
-- XOR
    W4(0) <= (input1(0) or input2(0)) and not (input1(0) and input2(0));
    W4(1) <= (input1(1) or input2(1)) and not (input1(1) and input2(1));
    W4(2) <= (input1(2) or input2(2)) and not (input1(2) and input2(2));
    W4(3) <= (input1(3) or input2(3)) and not (input1(3) and input2(3));
    W4(4) <= (input1(4) or input2(4)) and not (input1(4) and input2(4));
    W4(5) <= (input1(5) or input2(5)) and not (input1(5) and input2(5));
    W4(6) <= (input1(6) or input2(6)) and not (input1(6) and input2(6));
    W4(7) <= (input1(7) or input2(7)) and not (input1(7) and input2(7));
    W4(8) <= (input1(8) or input2(8)) and not (input1(8) and input2(8));
    W4(9) <= (input1(9) or input2(9)) and not (input1(9) and input2(9));
    W4(10) <= (input1(10) or input2(10)) and not (input1(10) and input2(10));
    W4(11) <= (input1(11) or input2(11)) and not (input1(11) and input2(11));
    W4(12) <= (input1(12) or input2(12)) and not (input1(12) and input2(12));
    W4(13) <= (input1(13) or input2(13)) and not (input1(13) and input2(13));
    W4(14) <= (input1(14) or input2(14)) and not (input1(14) and input2(14));
    W4(15) <= (input1(15) or input2(15)) and not (input1(15) and input2(15));
