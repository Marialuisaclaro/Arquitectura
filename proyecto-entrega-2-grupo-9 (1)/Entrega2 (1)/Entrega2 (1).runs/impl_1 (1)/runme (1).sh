...
HD_PWD='C:/Users/Joaquin Camus/Documents/Progra/U/ArquiComputadores/proyecto-entrega-2-grupo-9/Entrega2/Entrega2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Principal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Principal.tcl -notrace
